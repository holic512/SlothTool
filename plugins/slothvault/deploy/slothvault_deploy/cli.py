...
@description Provides the Chinese interactive menu bundled by SlothTool for Docker Compose installation, application Release checks, safely selected system or official Docker Nginx reverse proxying, and Let’s Encrypt certificate operations.
