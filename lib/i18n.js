...
export const messages = {
    zh: {
        ...
        cli: {
            ...
            installUsage: '用法：slothtool install <plugin-alias> [--file <offline.tgz>]',
            bundleUsage: '用法：slothtool bundle <plugin-alias> [--output <offline.tgz>]',
        ...
        pluginAliases: {
            deprecated: '插件别名 "{legacy}" 已弃用，已按 "{canonical}" 处理。',
            migrationConflict: '检测到旧版与规范 SlothVault 插件安装同时存在；为避免覆盖，未自动迁移。',
            upgradeRequired: '[SLOTHVAULT_PLUGIN_UPGRADE_REQUIRED] 当前安装的是旧版 SlothVault MCP 插件，无法作为多功能包运行。请先执行：slothtool update slothvault'
        },
        config: {
        ...
        install: {
            ...
            targetEnvironment: '当前系统目标：{target}',
            checkingUpdates: '正在检查最新发布版本...',
            installingTo: '安装目录：{dir}',
            downloadingAsset: '正在下载发布资产：{assetName}',
            installingDependencies: '正在安装插件运行时依赖...',
            usingOfflineArchive: '正在使用离线插件归档：{name}',
            offlineCacheOnly: '归档未包含 node_modules，仅尝试使用本机 npm 离线缓存安装依赖。',
            offlineArchiveRequired: '必须提供离线插件归档路径。',
            offlineArchiveMissing: '未找到离线插件归档：{path}',
            offlineArchiveType: '离线插件归档必须是 .tgz 文件：{path}',
            archiveEmpty: '插件归档为空。',
            archiveUnsafePath: '插件归档包含不安全路径：{entry}',
            archiveUnsupportedEntry: '插件归档包含不支持的条目类型 "{type}"：{entry}',
            archiveListingMismatch: '无法可靠校验插件归档成员；已拒绝解包。',
            offlineDependenciesMissing: '离线归档未包含 node_modules，且本机 npm 缓存无法满足依赖。请使用 "slothtool bundle <alias>" 创建自包含归档。（{reason}）',
            offlinePackageMismatch: '归档包名不匹配：实际为 "{actual}"，官方插件要求 "{expected}"。',
        ...
        bundle: {
            created: '已创建可离线安装的插件归档：{path}',
            installHint: '离线安装：slothtool install {alias} --file {path}',
            packageMissing: '未找到已安装插件的 package.json：{path}',
            dependenciesMissing: '已安装插件 "{alias}" 存在运行时依赖，但没有 node_modules。请先在线更新或重装，再创建离线归档。',
            alreadyExists: '离线归档已存在：{path}'
        },
        uninstall: {
            start: '正在卸载插件：{alias}',
        ...
        uninstallAll: {
            ...
            warning: '此操作会删除 ~/.pipker/slothtool 下的全部数据。',
        ...
        sources: {
            ...
            offlineArchive: '本地离线归档',
            npmRegistry: 'npm registry',
            npmRegistryLegacy: 'npm registry（遗留）',
        ...
        tui: {
            ...
            update: {
                ...
                listTitle: '更新中心',
                pendingSummary: '等待检查',
                resultSummary: '{outdated} 可更新 | {failed} 失败',
                checkDescription: '先检查可更新项，再决定逐项更新或批量更新。',
                checkDetail: '当前尚未检查。',
                checkedSummary: '检查完成：可更新 {outdated} 项，失败 {failed} 项。',
                latestSummary: '检查完成：当前全部为最新。',
                noneOutdated: '当前没有可更新项。',
                statusLabels: {
                    unchecked: '未检查',
                    latest: '已是最新',
                    outdated: '可更新',
                ...
                detailCurrent: '当前版本：{version}',
                detailLatest: '最新版本：{version}',
                detailSource: '更新来源：{source}',
                detailReason: '失败原因：{reason}',
                detailReady: '按 Enter 执行检查更新。',
                latestNotice: '"{label}" 已是最新版本。',
                errorNotice: '"{label}" 检查失败：{reason}',
                scopeAll: 'SlothTool 本体与全部已安装插件',
                bulkScope: '{count} 个可更新目标',
                targetDescriptions: {
                    self: 'SlothTool 本体版本',
                    plugin: '已安装插件版本'
                },
            ...
            uninstall: {
                empty: '没有可卸载的插件。',
                action: 'Enter 打开确认并执行卸载',
                listTitle: '卸载目标',
                count: '{count} 个插件',
                allTarget: '全部本地数据',
                pluginDescription: '移除该插件的运行文件、配置与注册表记录。',
                allDescription: '清理 SlothTool 的全部本地数据，所有插件和配置都会被移除。',
                pluginScope: '插件文件、配置与注册表记录',
                allScope: '~/.pipker/slothtool 下的全部数据',
                badges: {
                    confirm: '需确认',
                    danger: '高风险'
                },
            ...
            settings: {
                ...
                descriptions: {
                    language: '控制 TUI 与命令行输出所使用的语言。',
                    proxyToggle: '控制网络请求是否经过本地 HTTP 代理。',
                    proxyPort: '在常用本地代理端口之间快速切换。',
                    githubSource: '在官方 GitHub 与 gh-proxy.com 下载源之间切换。'
                },
                fields: {
                    category: '类别',
                    current: '当前值',
            ...
            status: {
                ...
                pluginReturned: '插件 "{alias}" 已退出，已返回插件管理器。',
                pluginReturnedWithCode: '插件 "{alias}" 已退出，退出码 {code}。'
            },
            help: {
                title: '快捷键',
                lines: [
            ...
            actions: {
                checkUpdates: '检查更新',
                recheckUpdates: '重新检查更新',
                updateOutdated: '更新所有可更新项',
                updateAll: '更新全部插件',
    ...
    en: {
        ...
        commands: {
            ...
            bundle: 'Create offline plugin bundle',
        ...
        cli: {
            ...
            installUsage: 'Usage: slothtool install <plugin-alias> [--file <offline.tgz>]',
            bundleUsage: 'Usage: slothtool bundle <plugin-alias> [--output <offline.tgz>]',
        ...
        pluginAliases: {
            deprecated: 'The plugin alias "{legacy}" is deprecated and was handled as "{canonical}".',
            migrationConflict: 'Legacy and canonical SlothVault plugin installs both exist; neither was migrated or overwritten.',
            upgradeRequired: '[SLOTHVAULT_PLUGIN_UPGRADE_REQUIRED] The installed SlothVault MCP-only plugin cannot run as the multifunction package. Run: slothtool update slothvault'
        },
        config: {
        ...
        install: {
            ...
            targetEnvironment: 'Current system target: {target}',
            ...
            usingOfflineArchive: 'Using offline plugin archive: {name}',
            offlineCacheOnly: 'The archive has no node_modules; installing dependencies from the local npm offline cache only.',
            offlineArchiveRequired: 'An offline plugin archive path is required.',
            offlineArchiveMissing: 'Offline plugin archive was not found: {path}',
            offlineArchiveType: 'Offline plugin archive must be a .tgz file: {path}',
            archiveEmpty: 'The plugin archive is empty.',
            archiveUnsafePath: 'The plugin archive contains an unsafe path: {entry}',
            archiveUnsupportedEntry: 'The plugin archive contains unsupported entry type "{type}": {entry}',
            archiveListingMismatch: 'The plugin archive members could not be verified reliably; extraction was refused.',
            offlineDependenciesMissing: 'The offline archive has no node_modules and the local npm cache cannot satisfy its dependencies. Create a self-contained archive with "slothtool bundle <alias>". ({reason})',
            offlinePackageMismatch: 'Archive package mismatch: found "{actual}", but official plugin "{expected}" is required.',
        ...
        bundle: {
            created: 'Created an offline-installable plugin archive: {path}',
            installHint: 'Install offline: slothtool install {alias} --file {path}',
            packageMissing: 'Installed plugin package.json was not found: {path}',
            dependenciesMissing: 'Installed plugin "{alias}" has runtime dependencies but no node_modules directory. Update or reinstall it online before creating an offline bundle.',
            alreadyExists: 'Offline bundle already exists: {path}'
        },
        uninstall: {
        ...
        uninstallAll: {
            ...
            warning: 'This removes all data under ~/.pipker/slothtool.',
        ...
        sources: {
            githubRelease: 'GitHub Release',
            offlineArchive: 'Local offline archive',
            npmRegistry: 'npm registry',
            npmRegistryLegacy: 'npm registry (legacy)',
        ...
        tui: {
            ...
            update: {
                ...
                listTitle: 'Update center',
                pendingSummary: 'Awaiting check',
                resultSummary: '{outdated} outdated | {failed} failed',
                checkDescription: 'Check available updates first, then update one item or all outdated items.',
                checkDetail: 'No update check has been run yet.',
                checkedSummary: 'Update check complete: {outdated} outdated, {failed} failed.',
                latestSummary: 'Update check complete: everything is already up to date.',
                noneOutdated: 'There are no outdated items right now.',
                statusLabels: {
                    unchecked: 'Unchecked',
                    latest: 'Latest',
                    outdated: 'Outdated',
                ...
                detailCurrent: 'Current version: {version}',
                detailLatest: 'Latest version: {version}',
                detailSource: 'Source: {source}',
                detailReason: 'Reason: {reason}',
                detailReady: 'Press Enter to check for updates.',
                latestNotice: '"{label}" is already up to date.',
                errorNotice: 'Failed to check "{label}": {reason}',
                scopeAll: 'SlothTool core and every installed plugin',
                bulkScope: '{count} outdated targets',
                targetDescriptions: {
                    self: 'SlothTool core version',
            ...
            uninstall: {
                empty: 'No plugins are available to uninstall.',
                action: 'Press Enter to confirm and run the uninstall action',
                listTitle: 'Removal targets',
                count: '{count} plugins',
                allTarget: 'All local data',
                pluginDescription: 'Remove this plugin\'s runtime files, configuration, and registry entry.',
                allDescription: 'Remove all local SlothTool data, including every plugin and setting.',
                pluginScope: 'Plugin files, configuration, and registry entry',
                allScope: 'Everything under ~/.pipker/slothtool',
                badges: {
                    confirm: 'Confirm',
                    danger: 'High risk'
                },
            ...
            settings: {
                ...
                descriptions: {
                    language: 'Controls the language used by the TUI and command-line output.',
                    proxyToggle: 'Controls whether network requests use the local HTTP proxy.',
                    proxyPort: 'Switches quickly between common local proxy ports.',
                    githubSource: 'Switches downloads between official GitHub and gh-proxy.com.'
                },
                fields: {
                    category: 'Category',
                    current: 'Current',
            ...
            status: {
                ...
                pluginReturned: 'Plugin "{alias}" exited and control returned to the manager.',
                pluginReturnedWithCode: 'Plugin "{alias}" exited with code {code}.'
            },
            help: {
                title: 'Keymap',
                lines: [
            ...
            actions: {
                ...
                recheckUpdates: 'Check again',
                updateOutdated: 'Update all outdated items',
                updateAll: 'Update all plugins',
