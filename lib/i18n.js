...
export const messages = {
    zh: {
        ...
        pluginAliases: {
            ...
            migrationConflict: '检测到旧版 SlothVault 数据与新位置同时存在；为避免覆盖，未自动合并冲突文件。'
        },
        config: {
    ...
    en: {
        ...
        pluginAliases: {
            ...
            migrationConflict: 'Legacy and canonical SlothVault data both exist; conflicting files were not merged or overwritten.'
        },
        config: {
