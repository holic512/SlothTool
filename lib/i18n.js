...
export const messages = {
    zh: {
        ...
        tui: {
            ...
            home: {
                eyebrow: 'DEFAULT TUI',
                lead: '默认入口是 Ink 全屏界面，底层能力保持脚本友好 CLI。',
                prompt: '按 Tab 切换页面，Enter 执行当前操作。',
                tip: 'Tip: 显式命令如 install/list/update/config 仍然保留。'
            },
            install: {
                empty: '没有待安装的官方插件。',
                action: 'Enter 安装当前插件'
    ...
    en: {
        ...
        tui: {
            ...
            home: {
                eyebrow: 'DEFAULT TUI',
                lead: 'The default entry is an Ink full-screen UI while the underlying capabilities remain scriptable CLI commands.',
                prompt: 'Use Tab to switch pages and Enter to run the focused action.',
                tip: 'Tip: explicit commands like install/list/update/config still exist.'
            },
            install: {
