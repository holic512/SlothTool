 ...
 * @logic 1. 用 reporter 事件输出进度；2. 统一处理 GitHub Release 与遗留 npm 来源插件；3. 为 GitHub 请求与 npm 命令注入网络配置。
 * @dependencies Node: child_process/fs/https/os/path, Storage: ../registry.js, Settings: ../settings.js, Network: ./network-helper.js, Data: ../official-plugins.json, I18N: ../i18n.js
 * @index_tags 插件服务, 生命周期, GitHub Release, 代理配置, reporter, CLI底层
 * @author holic512
 */
