 ...
 * @description 定义根 TUI 页面顺序、状态计时、首页 logo 动画节奏和实心 logo 数据。
 * @logic 1. 固定根 TUI 页面顺序；2. 统一任务状态与首页 logo 动画节奏；3. 提供首页填充式 logo 字符画。
 * @dependencies None
...
export const HOME_LOGO_REVEAL_INTERVAL_MS = 35;
export const HOME_LOGO_REVEAL_STEP = 2;
