...
export function resolveStatusColor(mode, tone, hasConfirmAction) {
    ...
    if (mode === 'progress' || mode === 'result') {
        ...
        return mode === 'progress' ? ROOT_TUI_COLORS.accent : ROOT_TUI_COLORS.success;
    }
